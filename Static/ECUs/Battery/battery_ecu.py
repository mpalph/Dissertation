...
class BatteryECU(CANNode):
    ...
    def _handle_startup(self):
        ...
        print(f"[STATIC BATTERY ECU] System started")
    ...
    def _handle_shutdown(self):
        ...
        print(f"[STATIC BATTERY ECU] System stopped")
        ...
        def loop():
            if self.running:
                if self.started:
                    ...
                    self.send_message(self.broadcast_id, [0]*3 + [voltage])
...
if __name__ == "__main__":
    ecu = BatteryECU("STATIC BATTERY ECU", bus_name="vcan0")
