    ...
    def start_status_broadcast(self):
        ...
        def loop():
            if self.running:
                ...
                self.send_message(self.broadcast_id, payload)
...
if __name__ == "__main__":
    ecu = HeadlampECU("STATIC HEADLAMP ECU", bus_name="vcan0")
